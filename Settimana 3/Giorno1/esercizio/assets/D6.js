...
const n = 5;
const altroArray = (array, numero) => {
	return array.map((el) => el + numero);
};


console.log(altroArray(arr, n));
...
const stringa = ['piero', 'giovanni', 'antonio', 'filippo'];
const misuraStringa = (array) => {
  return array.map((el) =>  el = el.length);
}
console.log(misuraStringa(stringa))
